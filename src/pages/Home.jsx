    ...
    <div className="min-h-[calc(100dvh-64px)] bg-linear-to-br from-gray-800 to-black flex flex-col lg:flex-row">
      ...
      <section className="flex flex-col justify-center lg:w-1/2 lg:px-16 text-white">
        <div className="max-w-xl flex flex-col items-center text-center">
          ...
          <div className="hidden lg:inline-flex items-center gap-2 px-4 py-1 mb-8 rounded-full border border-white/20 bg-gray-700 text-[#CCFF00] tracking-widest text-xs font-semibold">
            <Sparkles size={14} />
            AI-POWERED KNOWLEDGE
          </div>

          <p className="hidden lg:block text-lg text-white/90 mb-6">
